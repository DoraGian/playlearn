...
public class anscor extends Activity {
	

	SQLiteDatabase mydb;
    private  String DBNAME = "GAME.db";    // THIS IS THE SQLITE DATABASE FILE NAME.
    private  String TABLE2 = "STATISTIC";   // THIS IS THE TABLE NAME
    int    wins , loses , id ;
