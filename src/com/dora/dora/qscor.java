...
public class qscor extends Activity {
	
	
	SQLiteDatabase mydb;
    private static String DBNAME = "GAME.db";    // THIS IS THE SQLITE DATABASE FILE NAME.
    private static String TABLE2 = "STATISTIC3";   // THIS IS THE TABLE NAME
	...
	protected void onCreate (Bundle savedInstanceState) {
		...
		showplays.setText("Ερωτήσεις : " + sumP());
		showwins.setText("Σωστά :  " + sumR());
		showloses.setText("Λάθη : " + sumW());
